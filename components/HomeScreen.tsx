    ...
    return (
        <div className="bg-gray-800 rounded-lg p-4 shadow-lg flex flex-col space-y-3 hover:bg-gray-700/50 transition-colors">
            ...
            <div className="grid grid-cols-3 gap-2 text-center text-sm">
                <button onClick={() => placeBet(game.teamA, game.odds.teamA)} className="bg-gray-700 p-2 rounded hover:bg-green-600 transition">
                 ...
                 <button onClick={() => placeBet('Empate', game.odds.draw)} className="bg-gray-700 p-2 rounded hover:bg-green-600 transition disabled:opacity-50" disabled={game.odds.draw === 0}>
                ...
                <button onClick={() => placeBet(game.teamB, game.odds.teamB)} className="bg-gray-700 p-2 rounded hover:bg-green-600 transition">
        ...
        <main className="flex-1 p-4 space-y-6">
            ...
            <div>
                ...
                <div className="space-y-4">
                    {mockGames.filter(g => g.time === 'Ao Vivo' || g.time === 'A seguir').map(game => <GameCard key={game.id} game={game} />)}
                </div>
            </div>
